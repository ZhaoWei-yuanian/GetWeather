...
/**
 * @author ：mmzs
 * @date ：Created in 2019/8/20 10:05
 * @description：
 * @modified By：
 * @version: $
 */
...
//            System.out.println(str);
        ...
        // 设置收件人邮箱地址
        //message.setRecipient(Message.RecipientType.TO, new InternetAddress("收件人邮箱地址"));//一个收件人
        // 设置邮件标题
        message.setSubject("标题  "+new Date());
        // 设置邮件内容
//        message.setText(Content);//纯文本发送
        ...
        // 连接自己的邮箱账户
        transport.connect("发件人邮箱地址", "发件人邮箱密码");// 密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        // 发送邮件
